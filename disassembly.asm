...
P02_W035:
  0251 @0235  060  0TA           
; M[0x1c] must contain status represented by leftmost
; position includes E=error, F=1st shift, G=2nd shift
...
; Ah! Status flag turns into special display character.
P02_W031:
  0260 @0231  023  LBL           
...
SET_MEM_0C_BIT8_ENTRY:
  3777 @3701  300  GO             TOGGLE_MEM_BIT8P00_W067:
  0053 @0067  211  CALL           LOAD_MEM_15
  0054 @0033  116  SM 2          
  0055 @0015  147  LG             LGCALL WEIRD_SHUFFLE
  0056 @0046  200  DATA    2,00
