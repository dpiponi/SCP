...
SEMANTIC_LABELS = {
    ...
    0o3723: "SHIFT_ZERO_INTO_MAIN_FIELD",
    0o3724: "LOAD_MAIN_FIELD_PTR",
    0o3725: "SHIFT_MAIN_FIELD",
    ...
    comments.update(
        {
            ...
            0o0123: "repeated CALL 057 pattern now reads as repeated field shifting over fixed RAM regions",
            ...
            0o3724: "helper path selecting MAIN_FIELD before the shift/propagate loop",
