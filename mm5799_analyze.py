...
SEMANTIC_LABELS = {
    ...
    0o0331: "COPY_BANK1_TO_BASE_LOOP",
    0o0445: "INSERT_SCAN_STATE_INTO_MAIN_FIELD",
    0o2214: "SHIFT_SCAN_STATE_TO_SPECIAL_LATCH",
    0o0660: "COPY_EXP_STATE_TO_BASE_BACKWARD",
    0o3072: "SWAP_EXP_STATE_BACKWARD",
    ...
    0o3700: "SKIP_IF_MEM_B_IS_ZERO",
    0o3702: "SHIFT_LEFT_FLAG_A",
    0o3703: "SHIFT_LEFT_FLAG_011",
    0o3706: "INCREMENT_ANNUNCIATOR",
    0o3716: "RIPPLE_ADD_FROM_CURRENT_PTR",
    0o3717: "CLEAR_SCAN_STATE",
    0o3714: "INCREMENT_FLAG_B",
    0o3721: "CLEAR_FLAG_C",
    0o3722: "ZERO_FROM_CURRENT_PTR",
    0o3723: "SHIFT_MAIN_RIGHT",
    0o3724: "LOAD_MAIN_FIELD_PTR",
    0o3725: "SHIFT_REGISTER_RIGHT",
    0o3730: "SCAN_BACK_MAIN_FIELD_ZEROES",
    0o3720: "CLEAR_2_15",
    0o3735: "DECREMENT_FLAG_B",
    0o3740: "LOAD_ANNUNCIATOR_PTR",
    0o3743: "SWAP_2_15_2",
    0o3744: "SWAP_2_12_2",
    0o3736: "SUBTRACT_WITH_BORROW",
    0o3747: "LOAD_PTR_1_7",
    0o3715: "INCREMENT_2_14",
    0o3752: "COPY_2_15_2",
    0o3754: "COPY_CURRENT_TO_FIELD2_BACKWARD",
    0o3761: "INCREMENT_2_14_ALT",
    0o3764: "ADD_REGISTER_2_5_2",
    ...
    0o3753: "COPY_FLAG_C_2",
    0o3760: "SUB_REGISTER_2_5",
    0o3765: "ADD_REGISTER_2_14_2",
    0o3773: "LOAD_B_4_12",
    ...
    0o0542: "PROGRAM_DIGIT_REINIT",
    0o0551: "SHIFT_AND_REPACK_STAGE",
    0o0561: "RIPPLE_ADD_AND_SHIFT_STAGE",
    0o2700: "MODE_STATE_NORMALIZATION",
    0o2733: "NORMALIZATION_UPDATE_LOOP",
    0o2771: "SET_PTR_AND_RIPPLE_INCREMENT",
    0o3100: "MODE_TRANSITION_PREP",
    0o3121: "MODE_TRANSITION_STAGE",
    0o3500: "REGISTER_1_9_MODE_PATH",
    0o3566: "REGISTER_1_9_UPDATE_LOOP",
}
    ...
    comments.update(
        {
            ...
            0o0065: "page-37 entry here is not just a pointer load; with first-LB semantics it behaves like CLEAR_SCAN_STATE",
            0o0116: "page 1 opens a standardized field-normalization block",
            0o0123: "repeated CALL 057 pattern now reads as repeated right-shift over fixed RAM regions",
            0o0330: "MODE_STATE_A pointer seed for the bank1-to-base copy loop below",
            0o0445: "SCAN_STATE is inserted into MAIN_FIELD with an EXC+ / EXC shuttle pair",
            0o0660: "reverse copy loop from EXP_STATE into the paired base-bank field",
            ...
            0o2220: "EXC+ here is part of a staging shuffle between SCAN_STATE and the neighboring special latch",
            ...
            0o3072: "reverse swap loop between EXP_STATE and the paired base-bank field",
            ...
            0o3717: "with first-LB semantics this entry behaves as CLEAR_SCAN_STATE rather than a mere SCAN_STATE selector",
            0o3724: "helper path selecting MAIN_FIELD before the right-shift loop",
            0o3736: "helper path that begins with RSC and falls into shared local control",
            0o3754: "reverse copy helper from the current field into field 2",
